...
##SourceEmailid= "notification@partner.sample.com"
    ...
    try:
        ...
        Message={
            ...
            "Body": {
                "Text": {
                    "Charset": "UTF-8",
                    "Data": "Hello Super Admin's," + "\nThis is an automated email from SFTP AWS Server to notify the following issue for the user :- "+ Username +" . "+ Email_Body + "\n\nRegards" + "\nSupport Team"
                }
            }
        }
        )  
...
def Function_BANK_sendemail(Email_Subject, Email_Body, Username):
    ...
    Message={
        "Subject": {
            "Charset": "UTF-8",
            "Data": "SSH Key Roration Notification",
        },
        "Body": {
            "Text": {
                "Charset": "UTF-8",
                "Data": "Hello," + "\n\nThe SSH key used to authenticate your banking institution to SFTP AWS server needs rotation. To maintain security and compliance, we request that you: "+ "\n\n    1. Generate a new SSH key for authentication," + "\n    2. Provide the public key to prodops.linux@abc.com" + "\n    3. Provide an indicative date that future connections will be using the new key." + "\n\nNote that this email is auto-generated. If you’re unable to action the above, please pass this email to your IT team to Email us at support@abc.com." + "\n\nRegards" + "\nSupport Team"
            }
        }
    }
    )
